-- Active: 1699519738665@@127.0.0.1@5432@salary_management
CREATE DATABASE salary_api;
...
CREATE TABLE validations (
    ...
    ddo_code BIGINT UNIQUE NOT NULL,
    password VARCHAR(50)
);

-- Followed by your INSERT statement
INSERT INTO validations (id,user_name, ddo_code, password) VALUES
(1,'Hari Krishna', 12345678901, 'hari'),
(2,'Imran Khan', 12345678902, 'imran'),
(3,'Jhonson', 12345678903, 'jhon');


ALTER TABLE employee_details
ADD COLUMN ddo_code  BIGINT REFERENCES validations(ddo_code);

UPDATE employee_details
SET ddo_code = 12345678902
WHERE employee_code = '2000100004';
